...
FDCalendar.prototype = {
    ...
    , buildButtonsDiv: function () {
        ...
        var todayBtn = new FDButton({
            text: '今天', onclick: function () {
                that.setToday();
            }
        });
        var clearBtn = new FDButton({
...
FDFormPanel.prototype = {
    ...
    , submit: function (callback) {
        ...
        if (success) {
            ...
            var that = this;
            FDLib.ajax.request({
                url: url, params: data, success: function (e) {
...
FDLib.ajax = {
    ...
    request: function (options) {
        ...
        var callback = options.success || function (e) {
                alert(e)
            };
...
FDModel.prototype = {
    ...
    postData: function (url, schData, callback) {
        FDLib.ajax.request({
            url: url, params: schData, success: callback, error: function () {
                alert('查询出错,请查看日志');
            }
        });
    }

...
<div class="search-wrap">
    <div class="search-content">
        <table class="search-tab">
            <tr>
                <th>订单ID:</th>
                <td id="txt-orderIdSch"></td>
                <th>城市:</th>
                <td id="txt-cityNameSch"></td>
                <td>
                    <div id="btnSch"></div>
                </td>
            </tr>
    ...
    (function () {
        ...
        formPanel = new FDFormPanel({
            ...
            , controls: [
                ...
                , new FDTextBox({
                    domId: 'txt-cityName', name: 'cityName', msgId: 'formMsg', width: 200
                    , validates: [
                ...
                , new FDTextBox({
                    domId: 'txt-mobile', name: 'mobile', msgId: 'formMsg', width: 200
                    , validates: [
                ...
                , new FDTextBox({
                    domId: 'txt-address', name: 'address', msgId: 'formMsg', width: 200
                    , validates: [

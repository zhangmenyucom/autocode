    ...
    (function () {
        ...
        formPanel = new FDFormPanel({
            ...
            , controls: [
                ...
                , new FDTextBox({
                    domId: 'txt-name', name: 'name', msgId: 'formMsg', width: 200
                    , validates: [
                ...
                , new FDTextBox({
                    domId: 'txt-jdbcUrl', name: 'jdbcUrl', msgId: 'formMsg', width: 400
                    , validates: [
                ...
                , new FDTextBox({
                    domId: 'txt-username', name: 'username', msgId: 'formMsg', width: 200
                    , validates: [
                ...
                , new FDTextBox({
                    domId: 'txt-password', name: 'password', msgId: 'formMsg', width: 200
                    , validates: [

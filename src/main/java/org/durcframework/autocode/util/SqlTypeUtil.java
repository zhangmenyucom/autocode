...
public class SqlTypeUtil {
    ...
    private static final Map<String, String> javaBoxTypeMap = new HashMap<String, String>();
    private static final Map<String, String> mybatisTypeMap = new HashMap<String, String>();

...
public class DateUtil {
    private static DateFormat YMDHMS_FORMAT = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.sss");
    private static DateFormat YMD_FORMAT = new SimpleDateFormat("yyyy-MM-dd");
